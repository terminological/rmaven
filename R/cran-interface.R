...
#'
#' This calculates the dependencies for an artifact which may be specified
#' either as a set of maven coordinates (in which case the artifact is
...
#' jar-with-dependencies, or a assembled `...-src.jar`) The resulting file paths
#' which will be in the maven local cache are checked on the file system.
#'
